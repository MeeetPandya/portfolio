...
export default function Intro() {
  return (
    <div>
        ...
        <div className="mt-3 flex flex-row max-w-xs leading-normal group">
                    <a href="https://maps.app.goo.gl/tgnfczhaSu5G9tQFA" className="mt-3 flex flex-row nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200 items-center" target='_blank' rel='noreferrer noopener' aria-label="Location - Vadodara (Opens in new tab)" title="Location">
                        <span className="mr-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-geo w-4 h-4" viewBox="0 0 16 16">
